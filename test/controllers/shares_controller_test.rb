...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { email: @share.email, message: @share.message, recipient_email: @share.recipient_email, url_string: @share.url_string }
    end
  ...
  test "should update share" do
    patch :update, id: @share, share: { email: @share.email, message: @share.message, recipient_email: @share.recipient_email, url_string: @share.url_string }
    assert_redirected_to share_path(assigns(:share))
  end
